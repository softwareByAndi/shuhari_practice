...
const shuModules: ShuModule[] = [
  {
    id: 'addition',
    title: 'Single Digit Addition',
    description: 'Practice adding two numbers from 0-9',
    emoji: '➕',
    level: 'shu',
    href: '/practice/math/addition',
  },
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Coming Soon Card */}
            <div className="bg-zinc-100 dark:bg-zinc-800/50 rounded-2xl p-8 border-2 border-dashed border-zinc-300 dark:border-zinc-700 flex flex-col items-center justify-center text-center opacity-60">
